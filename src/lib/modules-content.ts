...
export const moduleContent: Record<ModuleSlug, ModuleContent> = {
  planification: {
    ...
    seoDescription:
      "Planning multi-sites pour entreprises de nettoyage : récurrences, affectations et remplacements sans Excel. Gratuit pour indépendants. Essai 15 jours Pro/Premium.",
    benefits: [
      {
    ...
    faq: [
      ...
      { q: "Le module planning est-il payant en supplément ?", a: "Non. Tous les modules sont inclus, même dans l'offre Gratuit pour indépendants." },
  ...
  clients: {
    ...
    seoDescription:
      "Fiches clients, sites illimités et historique pour entreprises de nettoyage. Fini les infos dispersées. Inclus Gratuit pour indépendants. Essai 15 jours sans carte bancaire.",
    benefits: [
    ...
    faq: [
      { q: "Combien de clients et sites puis-je créer ?", a: "Clients et sites illimités. Gratuit pour indépendants, Pro ou Premium pour les équipes." },
  ...
  impayes: {
    ...
    seoDescription:
      "Suivez factures impayées et relances pour entreprises de nettoyage. Trésorerie sous contrôle, sans Excel. Gratuit pour indépendants. Essai 15 jours Pro/Premium.",
    benefits: [
  ...
  "gestion-rh": {
    ...
    seoDescription:
      "RH, absences et heures terrain pour entreprises de nettoyage. Lié au planning et pointage. Gratuit pour indépendants. Essai 15 jours Pro/Premium.",
    benefits: [
    ...
    solutionBody:
      "Le module RH de PROGESTI connecte les fiches agents au planning et au pointage. Vous gérez contrats, absences et remplacements au même endroit où vous affectez les passages. Une absence signalée déclenche la recherche de backup sur le planning ; les heures pointées alimentent les variables de paie sans ressaisie. Chaque agent a sa fiche : coordonnées, type de contrat, sites habituels, historique d'interventions. Le bureau voit la charge du mois par agent avant de valider la prépaie. Ce n'est pas un logiciel de paie complet, mais la base fiable que votre comptable ou votre expert paie attend — heures réelles, propres, traçables. Gratuit pour indépendants, tous modules inclus. Essai 15 jours sur Pro/Premium.",
    solutionBullets: [
  ...
  rentabilite: {
    ...
    seoDescription:
      "Marges par client et site pour entreprises de nettoyage. Tableaux de bord alimentés par le réalisé. Gratuit pour indépendants. Essai 15 jours Pro/Premium.",
    benefits: [
    ...
    faq: [
      ...
      { q: "Module payant en supplément ?", a: "Non. Inclus dans toutes les offres, y compris Gratuit." },
  ...
  crm: {
    ...
    seoDescription:
      "CRM intégré pour entreprises de nettoyage : prospects, devis et relances dans le même outil que l'ops. Gratuit pour indépendants. Essai 15 jours Pro/Premium.",
    benefits: [
    ...
    excelComparison: [
      ...
      { aspect: "Outils", excel: "CRM + ops + compta séparés", progesti: "Tout dans PROGESTI — Gratuit pour indépendants" },
    ],
    workflow: [
    ...
    faq: [
      ...
      { q: "Inclus dans le tarif ?", a: "Oui — Gratuit pour indépendants, Pro/Premium pour équipes." },
