...
export const moduleContent: Record<ModuleSlug, ModuleContent> = {
  ...
  devis: {
    ...
    faq: [
      ...
      { q: "Le module est-il inclus dans le tarif ?", a: "Oui — dès 29,99 € HT par mois, tous modules compris (Starter, Pro ou Premium)." },
  ...
  facturation: {
    ...
    faq: [
      ...
      { q: "Le module est-il inclus ?", a: "Oui — dès 29,99 € HT par mois, tous modules compris (Starter, Pro ou Premium), sans module payant en supplément." },
  ...
  impayes: {
    ...
    faq: [
      ...
      { q: "Inclus dans le tarif ?", a: "Oui — dès 29,99 € HT par mois, tous modules compris (Starter, Pro ou Premium), sans supplément." },
  ...
  crm: {
    ...
    faq: [
      ...
      { q: "Inclus dans le tarif ?", a: "Oui — dès 29,99 € HT par mois, tous modules (Starter, Pro ou Premium)." },
