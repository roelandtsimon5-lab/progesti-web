...
const items: Item[] = [
  // —— Site (post sprints) ——
  {
    ...
    tag: "Référence",
    desc: "IndustryLanding V3 · titre plus lisible · Gratuit.",
    status: "keep",
    group: "site",
  },
  {
    href: "/v3",
    title: "Archive V3 — snapshot",
    tag: "Archive",
    desc: "IndustryLanding figée (même base visuelle).",
    status: "archive",
    group: "home",
  },
  {
    href: "/ancien",
    title: "Ancienne home HomeValidated",
    tag: "Archive",
  ...
  },
  {
    ...
    tag: "V4",
    desc: "Gratuit HT · tarifs publics.",
    status: "priority",
    group: "landing",
  },
  {
