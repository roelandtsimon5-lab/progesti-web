          ...
          <div className="industry-hero-rise industry-hero-rise-delay relative">
            ...
            >
              <div className="relative aspect-[16/10]">
                ...
                <div className="absolute bottom-[5.5rem] right-3 z-10 hidden w-[58%] max-w-[300px] rotate-[2deg] overflow-hidden rounded-[2px] border border-white/20 bg-white shadow-[0_28px_70px_rgba(0,0,0,0.5)] transition duration-500 group-hover:rotate-[1deg] group-hover:scale-[1.02] sm:block md:bottom-[6.25rem] md:right-5">
                  <Image
                    src={homeCreative.productStrip.src}
                    alt={homeCreative.productStrip.alt}
                    width={640}
                    height={400}
