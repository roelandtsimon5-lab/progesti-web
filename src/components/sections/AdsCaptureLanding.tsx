    ...
    <div className="ads-lp min-h-screen bg-[#F5F8FB] text-ink">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-5 pb-20 pt-7 sm:px-8 sm:pt-10 md:px-12 md:pb-24 md:pt-14">
        <header className="flex items-center justify-between gap-4">
          ...
          <p className="rounded-[2px] border border-lime-cta/40 bg-lime-cta/15 px-3.5 py-2 text-xs font-bold text-brand-navy sm:text-sm">
        ...
        <div className="grid flex-1 items-start gap-12 pt-12 sm:gap-14 sm:pt-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-20 lg:pt-16">
          <div className="order-2 space-y-8 lg:order-1 lg:space-y-10">
            <div className="space-y-5">
              <h1 className="max-w-xl text-[1.85rem] font-extrabold leading-[1.15] tracking-tight text-brand-navy sm:text-[2.35rem] md:text-[2.75rem]">
                {headline}
              </h1>
            ...
            {bullets?.length ? (
              <ul className="space-y-3.5">
                {bullets.map((b) => (
                  <li
                    key={b}
                    className="flex gap-3 text-[0.95rem] font-semibold leading-snug text-brand-navy sm:text-base"
                  >
                    <span className="mt-0.5 shrink-0 text-lime-cta" aria-hidden>
                      ✓
                    </span>
                    <span>{b}</span>
                  </li>
            ...
            <div className="overflow-hidden rounded-[2px] border border-line bg-white shadow-[0_16px_50px_rgba(1,41,57,0.1)]">
          ...
          <div className="order-1 lg:order-2 lg:sticky lg:top-10">
            <div className="rounded-[2px] border border-line bg-white p-7 shadow-[0_20px_60px_rgba(1,41,57,0.12)] sm:p-9 md:p-10">
              <div className="mb-3 h-1.5 w-14 rounded-[2px] bg-lime-cta" />
              <p className="font-display text-xs font-bold uppercase tracking-[0.18em] text-lime-cta">
                Accès immédiat
              </p>
              <h2 className="mt-3 text-[1.65rem] font-extrabold leading-tight text-brand-navy sm:text-3xl">
                Voir la plateforme
              </h2>
              ...
              <form onSubmit={onSubmit} className="mt-8 space-y-5" noValidate>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="min-h-14 w-full rounded-[2px] border border-line bg-white px-4 text-base font-semibold text-ink outline-none placeholder:text-muted focus:border-brand-navy focus:ring-4 focus:ring-lime-cta/25"
                  />
                </div>
                <div>
                  <label
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex min-h-14 w-full items-center justify-center rounded-[2px] bg-lime-cta font-display text-base font-extrabold text-brand-navy transition hover:bg-lime-cta-hover disabled:opacity-70"
                >
              ...
              <p className="mt-3 text-center text-sm font-semibold text-brand-navy">
                Ou appelez{" "}
                <a
                  href={`tel:${site.phoneTel}`}
                  className="text-lime-cta underline underline-offset-2 hover:text-brand-navy"
