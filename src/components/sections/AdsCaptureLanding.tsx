        ...
        <div className="grid flex-1 items-start gap-12 pt-12 sm:gap-14 sm:pt-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-20 lg:pt-16">
          ...
          <div className="order-2 space-y-8 lg:order-1 lg:space-y-10">
            <div className="space-y-5">
              <h1 className="max-w-xl text-[1.85rem] font-extrabold leading-[1.15] tracking-tight text-[#0F1F33] sm:text-[2.35rem] md:text-[2.75rem]">
                {headline}
              </h1>
              <p className="max-w-lg text-base leading-relaxed text-[#374151] sm:text-lg">
                {subhead}
              </p>
            </div>
            ...
            {bullets?.length ? (
              <ul className="space-y-3.5">
                {bullets.map((b) => (
                  <li
                    key={b}
                    className="flex gap-3 text-[0.95rem] font-semibold leading-snug text-[#111827] sm:text-base"
                  >
                    <span className="mt-0.5 shrink-0 text-[#12B76A]" aria-hidden>
                      ✓
                    </span>
                    <span>{b}</span>
                  </li>
          ...
          <div className="order-1 lg:order-2 lg:sticky lg:top-10">
            <div className="rounded-3xl border border-[#E5E7EB] bg-white p-7 shadow-[0_20px_60px_rgba(17,24,39,0.1)] sm:p-9 md:p-10">
              ...
              <h2 className="mt-3 text-[1.65rem] font-extrabold leading-tight text-[#0F1F33] sm:text-3xl">
                Voir la plateforme
              </h2>
              ...
              <form onSubmit={onSubmit} className="mt-8 space-y-5" noValidate>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="min-h-14 w-full rounded-xl border-2 border-[#D1D5DB] bg-white px-4 text-base font-semibold text-[#111827] outline-none placeholder:text-[#9CA3AF] focus:border-[#12B76A] focus:ring-4 focus:ring-[#12B76A]/25"
                  />
                </div>
                <div>
                  <label
