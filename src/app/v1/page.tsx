...
export const metadata: Metadata = {
  title: "V1 — Archive visuelle (ancien site)",
  description:
    "Copie archivée de la homepage PROGESTI V1, conservée comme référence avant la refonte V2.",
...
/**
 * Archive figée de la homepage marketing V1 (avant refonte esthétique / SEO V2).
 * Accessible sur /v1 — ne pas modifier sauf correction critique.
 */
export default function HomePageV1Archive() {
  return (
    <>
      <div className="border-b border-amber-300/80 bg-amber-50 px-4 py-3 text-center text-sm text-amber-950">
        <p className="font-semibold">
          Archive V1 — ancienne homepage PROGESTI (référence visuelle)
        </p>
          ...
          <div className="anim-rise">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <ButtonLink
                ...
                size="lg"
                event="trial_start"
                eventPayload={{ cta: "v1_archive_hero" }}
              >
              ...
              <ButtonLink
                ...
                size="lg"
                variant="secondary"
                eventPayload={{ cta: "v1_archive_demo" }}
              >
