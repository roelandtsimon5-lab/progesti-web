      ...
      objections={[
        {
          ...
          a: "Essai 15 jours gratuit + démarrage en quelques minutes. La démo interactive dure moins d’une minute pour se faire une idée.",
        },
        {
          q: "C’est trop cher pour un AE",
          a: "Gratuit, tous modules inclus.",
        },
        {
          q: "Et si ça ne me convient pas ?",
          a: "Vous testez 15 jours. Ensuite vous continuez ou vous arrêtez.",
        },
      ]}
    />
  );
