...
export default function LandingAlternativePage() {
  return (
    <LandingTemplate
      ...
      subhead="Vous utilisez déjà un logiciel (Propret ou autre) ? Comparez sans risque pendant 15 jours."
      primaryCta={{ href: cta.trialApp, label: "Tester PROGESTI 15 jours" }}
