  ...
  return (
    <>
      <IndustryPageHero
        eyebrow="Légal"
        title="Conditions générales de vente"
        lead={`Cadre contractuel de l'abonnement PROGESTI — Gratuit pour indépendants, essai ${site.trialDays} jours, modules inclus.`}
        breadcrumbs={[
          { label: "Accueil", href: "/" },
          { label: "CGV" },
        ]}
      ...
      <section className="section bg-white">
        <div className="container max-w-3xl space-y-8 text-sm leading-relaxed text-anthracite">
          ...
          <section>
            ...
            <p className="mt-2">
              Les offres PROGESTI sont décrites sur la page Tarifs : Gratuit 0 €
